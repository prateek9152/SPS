...
@Component({
  selector: 'app-preweddingshoot',
  templateUrl: './preweddingshoot.component.html',
  styleUrls: ['./preweddingshoot.component.css']
})
export class PreweddingshootComponent implements OnInit {
