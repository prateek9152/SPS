...
@Component({
  selector: 'app-viewmoreevents',
  templateUrl: './viewmoreevents.component.html',
  styleUrls: ['./viewmoreevents.component.css']
})
export class ViewmoreeventsComponent implements OnInit {
