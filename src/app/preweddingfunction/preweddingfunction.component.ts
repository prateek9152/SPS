...
@Component({
  selector: 'app-preweddingfunction',
  templateUrl: './preweddingfunction.component.html',
  styleUrls: ['./preweddingfunction.component.css']
})
export class PreweddingfunctionComponent implements OnInit {
